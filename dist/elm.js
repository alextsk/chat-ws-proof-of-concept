...
var author$project$Main$defaultUrl = 'ws://localhost:1234/chat';
...
var author$project$Main$init = function (_n0) {
	return Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
		{error: elm$core$Maybe$Nothing, key: 'socket', log: _List_Nil, messages: _List_Nil, send: 'Hello World!', state: author$project$PortFunnels$initialState, url: author$project$Main$defaultUrl, wasLoaded: false});
};
...
var author$project$Main$defaultMessage = _List_fromArray(
	[
					...
					_Utils_update(
						model,
						{
							messages: A2(
								...
								author$project$Main$defaultMessage,
								A2(
...
var author$project$Main$renderMessage = function (message) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$Main$b(message.origin),
				A2(
				elm$html$Html$span,
				_List_Nil,
				_List_fromArray(
				...
				elm$core$List$concat(
					_List_fromArray(
						[
							_List_fromArray(
							[
								author$project$Main$b('Chat:'),
								author$project$Main$br
							]),
							A2(
							elm$core$List$intersperse,
							author$project$Main$br,
							A2(elm$core$List$map, author$project$Main$renderMessage, model.messages))
						]))),
				A2(
				elm$html$Html$p,
				_List_Nil,
